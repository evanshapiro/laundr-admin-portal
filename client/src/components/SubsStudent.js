...
const SubsStudent = (props) => {
  ...
  if(monthSeries === null && subscriptionData != null){
    const data = generateStudent(new Date() - (2592000000*48), subscriptionData)
    const d = [{  
      name: 'Student Subscribers',
      data: data,
    }] 
    setMonthSeries(d)
  }
